...
const STORY_CHAPTERS = [
  {
    id: "chapter-1",
    title: "第一章：地下牌局",
    description: "先學會召喚單位、攻擊、處理守衛，再理解奢侈品升值。",
    clearTitle: "地下牌局破關",
    clearCopy: "你已經能完成基本出牌、攻擊與升值選擇。下一章會加入抽牌與目標法術。",
    clearImage: 0,
    battles: [
      {
        id: "c1-1",
      ...
      },
      {
        ...
        enemyOperator: "merc",
        enemyLife: 12,
        intro: "一般奢侈品留在手牌會逐回合升值，打出時可以選擇兩種不同用途。",
        hint: "提示：觀察卡牌的 +0／+1／+2，這場試著保留一張奢侈品後再打出。",
  ...
  },
  {
    ...
    battles: [
      ...
      },
      {
        ...
        enemyLife: 18,
        enemyShield: 3,
        intro: "最後一戰會用到前面所有觀念：守衛、護盾、抽牌、奢侈品升值與武器。",
        hint: "提示：權衡立即使用與等待升值；操作者守衛可以保護沒有守衛的單位。",
